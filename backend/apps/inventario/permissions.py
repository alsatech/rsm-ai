...
ROLES_AUTORIZAN_SOLICITUD = (User.Rol.INVENTARIO, User.Rol.ADMINISTRADOR, User.Rol.SUPERADMIN)
ROLES_REGISTRAN_ENVIO = (User.Rol.INVENTARIO, User.Rol.OPERACIONES, User.Rol.ADMINISTRADOR, User.Rol.SUPERADMIN)
